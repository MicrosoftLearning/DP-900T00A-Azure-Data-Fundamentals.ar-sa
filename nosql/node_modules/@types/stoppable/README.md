...
ms.locfileid: "138049947"
---
# <a name="installation"></a>التثبيت
> `npm install --save @types/stoppable`

# <a name="summary"></a>الملخص
تحتوي هذه الحزمة على تعريفات النوع للإيقاف (https://github.com/hunterloftis/stoppable).

# <a name="details"></a>التفاصيل
تم تصدير الملفات من https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/stoppable.
 ...
 * تاريخ آخر تحديث: الاثنين 31 مايو 2021 17:01:23 بتوقيت غرينتش
 * التبعيات: [@types/node](https://npmjs.com/package/@types/node)
 * القيم العالمية: لا شيء

# <a name="credits"></a>الائتمانات
كتب هذه التعريفات [Eric Byers](https://github.com/EricByers)و[John Plusjé](https://github.com/jplusje) و[BendingBender](https://github.com/BendingBender).
