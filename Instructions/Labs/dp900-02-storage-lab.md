...
1. في **صفحة Containers** ، حدد **&65291; حاوية** وإضافة حاوية جديدة باسم **البيانات** بمستوى وصول مجهول خاص **(بدون وصول مجهول)**.
...
2. حدد **التالي: >** النسخ الاحتياطي وتعطيل النسخ الاحتياطي. ثم حدد **«Review + create»**.
