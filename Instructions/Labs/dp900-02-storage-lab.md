...
1. تابع من خلال صفحات **Next >** المتبقية دون تغيير أي من الإعدادات الافتراضية، ثم في صفحة  **Review** ، انتظر حتى يتم التحقق من صحة التحديدات وحدد **Create** لإنشاء حساب Azure Storage الخاص بك.
