...
1. حدد "**Next: Advanced >**" واعرض خيارات التكوين المتقدمة. على وجه الخصوص، لاحظ أن هذا هو المكان الذي يمكنك فيه تمكين مساحة أسماء هرمية لدعم Azure Data Lake Storage Gen2. اترك هذا الخيار **<u>مسحا</u>** (ستقوم بتمكينه لاحقا)، ثم حدد **التالي: >** الشبكات لعرض خيارات الشبكات لحساب التخزين الخاص بك.
...
1. قم بتنزيل ملف JSON [product1.json](https://aka.ms/product1.json?azure-portal=true) من `https://aka.ms/product1.json` واحفظه على جهاز الكمبيوتر (يمكنك حفظه في أي مجلد - ستقوم بتحميله إلى تخزين كائن ثنائي كبير الحجم لاحقاً).
    ...
    *إذا تم عرض ملف JSON في المستعرض، فانقر بزر الماوس الأيمن فوق الصفحة، وحدد **حفظ باسم**. قم بتسمية الملف  **product1.json** وتخزينه في مجلد التنزيلات.* 
...
3. في **صفحة Containers** ، حدد **&65291; إضافة حاوية** وإضافة حاوية جديدة باسم `data` بمستوى وصول مجهول خاص **(بدون وصول مجهول)**.
...
8. حدد **&65291; أضف Directory** واقرأ المعلومات حول المجلدات قبل إنشاء دليل جديد باسم `products`.
...
10. في مسارات التنقل، حدد **data** للتبديل إلى الحاوية **data**، ولاحظ أنها <u>لا</u> تحتوي على مجلد باسم **products**.
...
12. في اللوحة **Upload blob**، حدد الملف **product1.json** الذي حفظته على جهاز الكمبيوتر المحلي مسبقاً. ثم في **المقطع خيارات متقدمة**، في **المربع تحميل إلى مجلد**، أدخل `product_data` زر تحميل** وحدده**.
...
17. حدد #x2027 **; &#x2027; &#x2027;** في الطرف الأيمن من المجلد، ولاحظ أن القائمة لا تعرض أي خيارات. المجلدات الموجودة في حاوية كائن ثنائي كبير الحجم لمساحة اسم ثابت هي مجلدات ظاهرية، ولا يمكن إدارتها.
