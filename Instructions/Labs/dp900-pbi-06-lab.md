...
من خلال إكمال هذا التمرين المعملي، ستتعلم كيفية استيراد البيانات ونمذجتها من مصادر متعددة في Power BI Desktop، وإنشاء علاقات وتسلسلات هرمية لتحليل أعمق، وتنسيق البيانات وتصنيفها لتحسين المرئيات. ستقوم بإنشاء تقارير تفاعلية باستخدام الجداول والمخططات والخرائط، واستكشاف رؤى البيانات من خلال ميزات التنقل لأسفل وتمييزها المتقاطع. ستمكنك هذه المهارات من تحويل البيانات الأولية إلى قصص مرئية جذابة وذكاء أعمال قابل للتنفيذ.
...
> _**تلميح**: Power BI Desktop هو أداة التأليف حيث تقوم بإنشاء نماذج وتقارير محليا قبل مشاركتها. إنه مجاني للتثبيت للتعلم والنماذج الأولية._
...
1. في شاشة الترحيب في Power BI Desktop، حدد **Get data from other sources**، ثم في قائمة مصادر البيانات، حدد **Web** ثم حدد **Connect**.
...
1. في مربع الحوار **From web**، أدخل عنوان URL التالي ثم حدد **OK**:
    ...
    > _**تلميح**: يعني استخدام موصل ويب مع ملفات CSV النموذجية أن الجميع يعمل من نفس البيانات النظيفة — لا توجد ملفات محلية أو بيانات اعتماد مطلوبة._
...
1. تحقق من أن عنوان URL يفتح مجموعة بيانات تحتوي على بيانات العميل، كما هو موضح أدناه. ثم حدد **Load** لتحميل البيانات في نموذج البيانات للتقرير الخاص بك.
    ...
    > _**تلميح**: تحميل البيانات مباشرة هو الأسرع لهذا المختبر. يمكنك دائما تطبيق التحويلات لاحقا في Power Query إذا لزم الأمر._
...
1. كرر الخطوات الثلاث السابقة لاستيراد مجموعة بيانات ثالثة تحتوي على بيانات الطلب من عنوان URL التالي:
    ...
    > _**تلميح**: يؤدي إحضار العملاء والمنتجات والطلبات إلى إنشاء نموذج صغير وواقعي. تتيح لك الجداول المتعددة ذات الصلة التحليل عبر الكيانات (على سبيل المثال، الإيرادات حسب فئة المنتج والمدينة)._
...
1. في جدول **orders**، حدد حقل **Revenue** ثم في جزء **Properties**، قم بتعيين خاصية **Format** الخاصة به إلى **Currency**:
    ...
    > _**تلميح**: تعمل مقاييس التنسيق على تحسين قابلية القراءة في المرئيات ومحاذاة الأرقام مع الطريقة التي يتوقع المستخدمون التجاريون رؤيتها._
...
1. في جدول "products"، انقر بزر الماوس الأيمن فوق الحقل "**ProductName**" (أو افتح القائمة **&vellip;**) وحدد "**Add to hierarchy** > **Category Hierarchy**". يؤدي هذا إلى إضافة حقل **ProductName** إلى التسلسل الهرمي الذي قمت بإنشائه مسبقاً.
    ...
    ![لقطة شاشة توضح كيفية إضافة prodcutname إلى التسلسل الهرمي للفئة في Power BI.](images/add-category-hierarchy.png)
...
1. في جزء **Fields**، انقر بزر الماوس الأيمن فوق **Category Hierarchy** (أو افتح القائمة **...**) وحدد **Rename**. ثم أعد تسمية التسلسل الهرمي إلى **Categorized Product**.
    ...
    > _**تلميح**: تتيح التدرج الهرمي للفئة→product التنقل لأسفل في المرئيات، حتى يتمكن المشاهدون من الاستكشاف من الملخص إلى التفاصيل._
...
1. حدد رأس العمود **City**، ثم عيّن الخاصية **Data Category** إلى **City**:
    ...
    > _**تلميح**: تساعد فئات البيانات مواقع التعليمات البرمجية الجغرافية ل Power BI بشكل صحيح بحيث تضع مرئيات الخريطة نقاطا في الأماكن الصحيحة._
...
1. في القائمة **File**، حدد **Options and Settings**. ثم حدد **Options**، وفي قسم **Security**، تأكد من تمكين ** استخدام تصورات المخطط والمخطط المعبأ ** وحدد **OK**.
    ...
    > _**تلميح**: يتم إيقاف تشغيل مرئيات الخريطة في بعض البيئات. يضمن تمكينها ظهور مرئية الخريطة في جزء المرئيات._
...
1. في الشريط، أعلى سطح تصميم التقرير، حدد **Text Box** وأضف مربع نص يحتوي على النص **Sales Report** إلى التقرير. قم بتنسيق النص لجعله غامقاً بحجم خط 32.
    ...
    > _**تلميح**: يساعد العنوان الواضح المستخدمين على فهم الغرض من التقرير بنظرة سريعة._
...
1. حدد أي منطقة فارغة في التقرير لإلغاء تحديد مربع النص. ثم في جزء **البيانات**، قم بتوسيع **المنتجات** وحدد حقل **المنتجات المقسمة لفئات**. تضيف هذه الخطوة جدولاً إلى التقرير.
    ...
    > _**تلميح**: يتيح لك الآن استخدام حقل التسلسل الهرمي التبديل إلى المرئيات التي تدعم التنقل لأسفل بسلاسة._
...
1. مع استمرار تحديد الجدول، في جزء **Visualizations**، حدد التصور **المخطط البياني العمودي المكدس**. تم تغيير الجدول إلى مخطط عمودي يعرض الإيرادات حسب الفئة.
    ...
    > _**تلميح**: يسهل المخطط العمودي مقارنة الفئات جنبا إلى جنب._

1. فوق المخطط البياني العمودي المحدد، حدد الرمز **&#8595;** لتشغيل التنقل لأسفل. ثم في المخطط، حدد أي عمود للتنقل لأسفل ورؤية إيرادات المنتجات الفردية في هذه الفئة. هذه الإمكانية ممكنة لأنك حددت تسلسلاً هرمياً للفئات والمنتجات.

    ![لقطة شاشة تعرض مخطط بياني عمودي يمكن التنقل لأسفل به لرؤية المنتجات داخل الفئة.](images/drill-down.png)

    > _**تلميح**: يكشف التنقل لأسفل عن التفاصيل حول الطلب دون الفوضى في العرض - مثالي للرؤى ذات الطبقات._
...
1. مع تحديد مخطط العمود الجديد، في جزء **Visualizations**، حدد **Pie chart** ثم غيّر حجم المخطط البياني وضعه بجوار المخطط البياني لعمود الإيرادات حسب الفئة.
    ...
    > _**تلميح**: يؤدي إظهار الكمية حسب الفئة كمخطط دائري إلى تمييز المساهمة النسبية، مما يكمل مخطط عمود الإيرادات._
...
1. حدد منطقة فارغة من التقرير، ثم في جزء **البيانات**، حدد حقل **المدينة** في جدول **العملاء** ثم حدد **الإيرادات** في جدول **الأوامر**. ما ينتج عنه خريطة توضح إيرادات المبيعات حسب المدينة. أعد ترتيب المرئيات وغيّر حجمها حسب الحاجة:
    ...
    > _**تلميح**: يضيف تعيين الإيرادات حسب المدينة عدسة جغرافية - يمكن أن تظهر الأنماط غير الواضحة في الجداول أو المخططات على الخريطة._
...
1. في المخطط، لاحظ أنه يمكنك السحب أو النقر المزدوج أو استخدام عجلة الماوس أو الضغط والسحب على شاشة اللمس للتفاعل. ثم حدد مدينة معينة، ولاحظ أنه تم تعديل التصورات الأخرى في التقرير لتمييز البيانات الخاصة بالمدينة المحددة.
    ...
    > _**تلميح**: يتيح التمييز المتقاطع للمستخدمين التفاعل مع مرئية واحدة ورؤية التغييرات ذات الصلة عبر الصفحة - تحويل تقرير ثابت إلى تجربة تفاعلية._
...
1. في القائمة **ملف**، حدد **حفظ**. ثم احفظ الملف باسم ملف .pbix مناسب. يمكنك فتح الملف واستكشاف نمذجة البيانات والتصور بشكل أكبر في وقت فراغك.
    ...
    > _**تلميح**: يؤدي حفظ .pbix إلى الاحتفاظ بالنموذج والاستعلامات والإبلاغ معا حتى تتمكن من إعادة الفتح والتكرار لاحقا._
...
> **تلميح**: يتيح لك النشر إلى خدمة Power BI مشاركة التقرير وجدولة التحديث والتعاون مع الآخرين في مساحة العمل.
