...
3. ابحث `Azure Synapse Analytics`عن ، وأنشئ مورد Azure Synapse Analytics** جديدا **بالإعدادات التالية:
...
8. على الجانب الأيسر من استوديو Synapse، استخدم الرمز **&rsaquo;&rsaquo;** لتوسيع القائمة - وهذا يكشف عن الصفحات المختلفة داخل Synapse Studio التي ستستخدمها لإدارة الموارد وتنفيذ مهام تحليل البيانات، كما هو موضح هنا:
    ...
    ![صورة توضح قائمة Synapse Studio المُوسّعة لإدارة الموارد وتنفيذ مهام تحليلات البيانات](images/synapse-studio.png)
...
3. في خطوة **"Source"** في الخطوة الفرعية **"Dataset"** حدد الإعدادات التالية:
    ...
    - **الاتصال**: *أنشئ اتصالًا جديدًا، وفي جزء **إتصال جديد** الذي يظهر، في علامة التبويب **البروتوكول العام**، حدد **HTTP**. ثم تابع وأنشئ اتصالًا بملف بيانات باستخدام الإعدادات التالية:*
        - **الاسم:** `AdventureWorks Products`
        - **الوصف**: `Product list via HTTP`
...
8. في **جزء Properties** ل **SQL Script 1**، غير **الاسم** إلى `Count Products by Category`. ثم في شريط الأدوات، حدد **"Publish"** لحفظ البرنامج النصي.
